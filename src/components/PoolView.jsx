...
export default function PoolView({ user, pool, poolId, onBack }) {
  ...
  return (
    <>
      ...
      <LastTimeOut fixtures={fixtures} results={results} allPicks={allPicks} allChips={allChips} members={members} userId={user.uid} poolId={poolId} />
