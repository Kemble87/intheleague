...
export default function App() {
  ...
  // Open the login screen in a specific mode: 'in' (sign in) or 'up' (sign up)
  const openLogin = (mode = 'in') => { setAuthMode(mode); setShowLogin(true) }
  useEffect(() => {
  ...
  if (!user) {
    if (showLogin) return <Login initialMode={authMode} />
    return <Landing onGetStarted={openLogin} />
  }
